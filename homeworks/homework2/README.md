To submit the homework, download __Homework2.ipynb__ and __text8.txt__ files to the same directory and follow the instructions in __Homework2.ipynb__ file.
