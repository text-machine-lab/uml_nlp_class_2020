To submit the homework, download __homework3.ipynb__ and __text8.txt__ files to the same directory and follow the instructions in __homework3.ipynb__ file.
