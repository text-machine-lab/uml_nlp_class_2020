To submit the homework, download __homework5.ipynb__ and the [dataset](eng-fra.txt) to the same directory and follow the instructions in the __homework5.ipynb__ file.
